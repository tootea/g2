...
XS(_wrap_g2_open_X11) {
    ...
    if ((items < 2) || (items > 2)) 
    croak("Usage: g2_open_X11(width,height);");
    arg1 = (int ) SvIV(ST(0));
    arg2 = (int ) SvIV(ST(1));
    result = (int )g2_open_X11(arg1,arg2);
...
XS(_wrap_g2_open_X11X) {
    ...
    if ((items < 9) || (items > 9)) 
    croak("Usage: g2_open_X11X(width,height,x,y,window_name,icon_name,icon_data,icon_width,icon_height);");
    arg1 = (int ) SvIV(ST(0));
    arg2 = (int ) SvIV(ST(1));
    arg3 = (int ) SvIV(ST(2));
    arg4 = (int ) SvIV(ST(3));
    ...
    arg8 = (int ) SvIV(ST(7));
    arg9 = (int ) SvIV(ST(8));
    result = (int )g2_open_X11X(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);
...
XS(_wrap_g2_set_dash) {
    ...
    arg2 = (int ) SvIV(ST(1));
    {
        if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_double) < 0) {
...
XS(_wrap_g2_query_pointer) {
    ...
    if ((items < 4) || (items > 4)) 
    croak("Usage: g2_query_pointer(dev,x,y,button);");
    arg1 = (int ) SvIV(ST(0));
    {
        if (SWIG_ConvertPtr(ST(1), (void **) &arg2, SWIGTYPE_p_double) < 0) {
            croak("Type error in argument 2 of g2_query_pointer. Expected %s", SWIGTYPE_p_double->name);
        }
    }
    {
        if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_double) < 0) {
            croak("Type error in argument 3 of g2_query_pointer. Expected %s", SWIGTYPE_p_double->name);
        }
    }
    {
        if (SWIG_ConvertPtr(ST(3), (void **) &arg4, SWIGTYPE_p_unsigned_int) < 0) {
            croak("Type error in argument 4 of g2_query_pointer. Expected %s", SWIGTYPE_p_unsigned_int->name);
        }
    }
...
{"g2::g2_open_X11", _wrap_g2_open_X11},
{"g2::g2_open_X11X", _wrap_g2_open_X11X},
